...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.cheroliv.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.cheroliv.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.cheroliv.domain.User::class.java.name)
            createCache(cm, com.cheroliv.domain.Authority::class.java.name)
            createCache(cm, com.cheroliv.domain.User::class.java.name + ".authorities")
